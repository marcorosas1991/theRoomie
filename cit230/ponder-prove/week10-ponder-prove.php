...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            body {margin:0; background-image: url(../images/garden.jpg); background-repeat: repeat; }
            ...
            div#left-col{position:absolute; left:0; width:25%; height:20em; border-left-style:dotted; border-right-style:dotted;}

            div#mid-col {margin-left:25%; width:50%; height: 20em; border: solid thin blue; float:left;}/*new css*/
            div#mid-col img {border:double;}
            div#mid-col p {text-align:center; font-size:14pt;}

            aside{position:absolute; right:0; width: 25%; height: 20em; border: solid thin blue; list-style:none;}

            footer {clear:both; top: 92%;  width: 100%; left: 0; position:none; border: solid medium black; text-align:center;}
            ...
            div#left-col {background-color:none;}
    ...
    <body>
        ...
        <section>
            ...
            <div id="mid-col">
                ...
                <br>
                <p> <img src="../images/computer-people.jpg" alt="computer and people" title="Enjoy using a comptuer in a cruise" /> </p>
